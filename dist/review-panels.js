import { checkLabels, } from './review-model.js';
import { el, badge, textBlock, link } from './review-dom.js';
export function renderCoverage(review, parent) {
...
export function renderSources(review, parent) {
...
export function ticketLinks(review, f, parent) {
...
export function evidenceDetail(review, f, parent) {
