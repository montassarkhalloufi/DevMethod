import { c as e, l as t } from "./editor.api-CBhnZFl3.js";
import { t as n } from "./workers-Ct0B1W_j.js";
import { _ as r, a as i, c as a, d as o, f as s, g as c, h as l, i as u, l as d, m as f, n as p, o as m, p as h, r as g, s as _, t as v, u as y, v as b } from "./lspLanguageFeatures-B9iGfGRp.js";
	...
	_getClient() {
		return this._lastUsedTime = Date.now(), this._client ||= (this._worker = n({
			...
			createWorker: () => new Worker(new URL(
				/* @vite-ignore */
				"/studio-ui/assets/json.worker-NqY_TxEu.js",
				"" + import.meta.url
			), { type: "module" }),
...
var X = class extends g {
	constructor(t, n, r) {
		super(t, n, r.onDidChange), this._disposables.push(e.onWillDisposeModel((e) => {
			this._resetSchema(e.uri);
		})), this._disposables.push(e.onDidChangeModelLanguage((e) => {
...
function Z(e) {
	...
	function c() {
		let { languageId: n, modeConfiguration: s } = e;
		$(r), s.documentFormattingEdits && r.push(t.registerDocumentFormattingEditProvider(n, new i(J))), s.documentRangeFormattingEdits && r.push(t.registerDocumentRangeFormattingEditProvider(n, new a(J))), s.completionItems && r.push(t.registerCompletionItemProvider(n, new v(J, [
			" ",
			":",
			"\""
		]))), s.hovers && r.push(t.registerHoverProvider(n, new o(J))), s.documentSymbols && r.push(t.registerDocumentSymbolProvider(n, new d(J))), s.tokens && r.push(t.setTokensProvider(n, N(!0))), s.colors && r.push(t.registerColorProvider(n, new u(J))), s.foldingRanges && r.push(t.registerFoldingRangeProvider(n, new y(J))), s.diagnostics && r.push(new X(n, J, e)), s.selectionRanges && r.push(t.registerSelectionRangeProvider(n, new f(J)));
	}
	c(), n.push(t.setLanguageConfiguration(e.languageId, te));
	let l = e.modeConfiguration;
