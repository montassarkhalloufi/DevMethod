...
import { a, c as o, i as s, l as c, n as ee, r as te, s as ne, t as l } from "./editor.api-CBhnZFl3.js";
...
var g = e(), _ = t(), v = Object.defineProperty, re = (e, t, n) => t in e ? v(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
}) : e[t] = n, y = (e, t, n) => re(e, typeof t == "symbol" ? t : t + "", n), b, x, S, C, w;
function ie(e) {
...
var oe = class {
	...
	constructor(e) {
		y(this, "_value"), y(this, "eventEmitter"), this._value = e, this.eventEmitter = new oe();
	}
	get value() {
		return this._value;
	}
...
b = class {
	constructor() {
		y(this, "_unprocessedMessages", []), y(this, "_messageListener"), y(this, "id", b.id++), y(this, "_state", new se({ state: "open" })), y(this, "state", this._state);
	}
	setListener(e) {
...
var ue = class {
	...
	mapContext(t) {
		return new e((e) => this.connect(e ? pe(e, t) : void 0));
	}
};
function pe(e, t) {
	return {
...
var me = class e {
	constructor(e, t, n) {
		y(this, "_stream"), y(this, "_listener"), y(this, "_logger"), y(this, "_unprocessedResponses", /* @__PURE__ */ new Map()), y(this, "_lastUsedRequestId", 0), this._stream = e, this._listener = t, this._logger = n, this._stream.setListener((e) => {
			ie(e) ? e.id === void 0 ? this._processNotification(e) : this._processRequest(e) : this._processResponse(e);
		});
	}
...
var O = Symbol("OptionalMethodNotFound"), he = class {
	contextualize(e) {
	...
	constructor(e, t = {}) {
		super(), y(this, "channelCtor"), y(this, "_requestSender"), y(this, "_handler", /* @__PURE__ */ new Map()), y(this, "_unknownNotificationHandler", /* @__PURE__ */ new Set()), y(this, "_timeout"), y(this, "sendExceptionDetails", !1), y(this, "_logger"), y(this, "listeningDeferred", new le()), y(this, "onListening", this.listeningDeferred.promise), y(this, "_requestDidErrorEventEmitter", new oe()), y(this, "onRequestDidError", this._requestDidErrorEventEmitter.event), this.channelCtor = e, this._logger = t.logger, this.sendExceptionDetails = !!t.sendExceptionDetails, this._timeout = ce(1e3, () => {
	...
	static fromTransport(t, n = {}) {
		return new e(me.createChannel(t, n.logger), n);
	}
	startListen() {
	...
	async request(e, t, n) {
		...
		if ("error" in i) {
			if (e.isOptional && i.error.code === T.methodNotFound) return O;
			let t;
			...
			let n = new ye(i.error.message, t, i.error.code);
...
${JSON.stringify(i, null, 2)}`);
	...
	async notify(e, t, n) {
		...
		let r = e.paramsSerializer.serializeToJson(t);
		ve(r), this._requestSender.sendNotification({
			method: e.method,
			params: r
		}, n);
	}
...
var ye = class e extends Error {
	constructor(t, n, r = T.genericApplicationError) {
...
function k(e) {
	return new be((e || {}).method, D.sAny(), D.sAny(), D.sAny());
}
function A(e) {
	return new xe((e || {}).method, D.sAny());
}
var Se = (x = Symbol(), S = class {
	constructor(e) {
		y(this, "error"), y(this, x), this.error = e;
	}
}, y(S, "factory", (e) => new S(e)), S);
function Ce(e) {
	let t = we(e.server), n = we(e.client);
	return new Te(e.tags || [], t, n);
}
function we(e) {
	let t = {};
...
var Te = class e {
		...
		for (let [r, i] of Object.entries(t)) {
			...
			t = i.kind === "request" ? i.isOptional ? async (t, n) => {
				...
				try {
					...
					if (e && e.code === T.methodNotFound) return O;
					throw e;
				}
	...
	createRequestHandler(e, t) {
		return async (n, r, i) => {
			...
			return a instanceof Se ? a.error : { ok: a };
		};
	}
...
}, y(C, "None", Object.freeze({ dispose() {} }));
var Ne = (w = class {
	constructor() {
	...
	add(e) {
		if (!e) return e;
		if (e === this) throw Error("Cannot register a disposable on itself!");
		return this._isDisposed ? w.DISABLE_DISPOSED_WARNING || console.warn((/* @__PURE__ */ Error("Trying to add a disposable to a DisposableStore that has already been disposed of. The added object will be leaked!")).stack) : this._toDispose.add(e), e;
	}
}, y(w, "DISABLE_DISPOSED_WARNING", !1), w);
F.Empty, F.QuickFix, F.Refactor, F.RefactorExtract, F.RefactorInline, F.RefactorRewrite, F.Source, F.SourceOrganizeImports, F.SourceFixAll, c.CodeActionTriggerType.Invoke, je.Invoked, c.CodeActionTriggerType.Auto, je.Automatic, N.Text, c.CompletionItemKind.Text, N.Method, c.CompletionItemKind.Method, N.Function, c.CompletionItemKind.Function, N.Constructor, c.CompletionItemKind.Constructor, N.Field, c.CompletionItemKind.Field, N.Variable, c.CompletionItemKind.Variable, N.Class, c.CompletionItemKind.Class, N.Interface, c.CompletionItemKind.Interface, N.Module, c.CompletionItemKind.Module, N.Property, c.CompletionItemKind.Property, N.Unit, c.CompletionItemKind.Unit, N.Value, c.CompletionItemKind.Value, N.Enum, c.CompletionItemKind.Enum, N.Keyword, c.CompletionItemKind.Keyword, N.Snippet, c.CompletionItemKind.Snippet, N.Color, c.CompletionItemKind.Color, N.File, c.CompletionItemKind.File, N.Reference, c.CompletionItemKind.Reference, N.Folder, c.CompletionItemKind.Folder, N.EnumMember, c.CompletionItemKind.EnumMember, N.Constant, c.CompletionItemKind.Constant, N.Struct, c.CompletionItemKind.Struct, N.Event, c.CompletionItemKind.Event, N.Operator, c.CompletionItemKind.Operator, N.TypeParameter, c.CompletionItemKind.TypeParameter, Oe.Deprecated, c.CompletionItemTag.Deprecated, c.CompletionTriggerKind.Invoke, L.Invoked, c.CompletionTriggerKind.TriggerCharacter, L.TriggerCharacter, c.CompletionTriggerKind.TriggerForIncompleteCompletions, L.TriggerForIncompleteCompletions, ke.Snippet, c.CompletionItemInsertTextRule.InsertAsSnippet, M.File, c.SymbolKind.File, M.Module, c.SymbolKind.Module, M.Namespace, c.SymbolKind.Namespace, M.Package, c.SymbolKind.Package, M.Class, c.SymbolKind.Class, M.Method, c.SymbolKind.Method, M.Property, c.SymbolKind.Property, M.Field, c.SymbolKind.Field, M.Constructor, c.SymbolKind.Constructor, M.Enum, c.SymbolKind.Enum, M.Interface, c.SymbolKind.Interface, M.Function, c.SymbolKind.Function, M.Variable, c.SymbolKind.Variable, M.Constant, c.SymbolKind.Constant, M.String, c.SymbolKind.String, M.Number, c.SymbolKind.Number, M.Boolean, c.SymbolKind.Boolean, M.Array, c.SymbolKind.Array, M.Object, c.SymbolKind.Object, M.Key, c.SymbolKind.Key, M.Null, c.SymbolKind.Null, M.EnumMember, c.SymbolKind.EnumMember, M.Struct, c.SymbolKind.Struct, M.Event, c.SymbolKind.Event, M.Operator, c.SymbolKind.Operator, M.TypeParameter, c.SymbolKind.TypeParameter, Ee.Deprecated, c.SymbolTag.Deprecated, P.Text, c.DocumentHighlightKind.Text, P.Read, c.DocumentHighlightKind.Read, P.Write, c.DocumentHighlightKind.Write, j.Comment, c.FoldingRangeKind.Comment, j.Imports, c.FoldingRangeKind.Imports, j.Region, c.FoldingRangeKind.Region, s.Error, I.Error, s.Warning, I.Warning, s.Info, I.Information, s.Hint, I.Hint, I.Error, s.Error, I.Warning, s.Warning, I.Information, s.Info, I.Hint, s.Hint, Ae.Unnecessary, a.Unnecessary, Ae.Deprecated, a.Deprecated, c.SignatureHelpTriggerKind.Invoke, R.Invoked, c.SignatureHelpTriggerKind.TriggerCharacter, R.TriggerCharacter, c.SignatureHelpTriggerKind.ContentChange, R.ContentChange, De.Type, c.InlayHintKind.Type, De.Parameter, c.InlayHintKind.Parameter, new Map([...Object.values(Me)].map((e) => [e.method, e])), typeof WebSocket < "u" || (typeof MozWebSocket < "u" ? MozWebSocket : typeof global < "u" ? global.WebSocket || global.MozWebSocket : typeof window < "u" ? window.WebSocket || window.MozWebSocket : typeof self < "u" && (self.WebSocket || self.MozWebSocket));
//#endregion
...
var Pe = {}, B = {}, Fe = class e {
	...
	load() {
		return this._loadingTriggered || (this._loadingTriggered = !0, Pe[this._languageId].loader().then((e) => this._lazyLoadPromiseResolve(e), (e) => this._lazyLoadPromiseReject(e))), this._lazyLoadPromise;
	}
};
function V(e) {
	let t = e.id;
	Pe[t] = e, c.register(e);
	let n = Fe.getOrCreate(t);
	c.registerTokensProviderFactory(t, { create: async () => (await n.load()).language }), c.onLanguageEncountered(t, async () => {
		let e = await n.load();
		c.setLanguageConfiguration(t, e.conf);
	});
}
//#endregion
...
}, Ie = new H("css", U, W), Le = new H("scss", U, W), Re = new H("less", U, W);
function G() {
	return import("./cssMode-BlgggzMT.js");
}
c.onLanguage("less", () => {
	G().then((e) => e.setupMode(Re));
}), c.onLanguage("scss", () => {
	G().then((e) => e.setupMode(Le));
}), c.onLanguage("css", () => {
...
var J = "html", Be = "handlebars", Ve = "razor";
Y(J, K, q(J)).defaults, Y(Be, K, q(Be)).defaults, Y(Ve, K, q(Ve)).defaults;
function He() {
	return import("./htmlMode-BuU-k5Gz.js");
}
function Y(e, t = K, n = q(e)) {
	let r = new ze(e, t, n), i, a = c.onLanguage(e, async () => {
		i = (await He()).setupMode(r);
	});
	return {
		defaults: r,
		dispose() {
...
c.register({
	...
	We().then((e) => e.setupMode(Ue));
});
//#endregion
//#region node_modules/monaco-editor/esm/vs/features/find/register.js
var X = "__monacoFindWidgetTabIndexPatchApplied", Z = "__monacoFindWidgetOriginalTabIndex";
function Ge(e, t) {
	let n = e?._domNode;
	if (!n) return;
...
if (!u[X]) {
	...
	u.prototype._reveal = function(...t) {
		e.apply(this, t), Ge(this, !0);
	}, u.prototype._hide = function(...e) {
		t.apply(this, e), Ge(this, !1);
	}, u[X] = !0;
}
//#endregion
...
globalThis.MonacoEnvironment = { getWorker(e, t) {
	return t === "typescript" || t === "javascript" ? new qe() : t === "json" ? new Je() : [
		"css",
		"scss",
		"less"
	].includes(t) ? new Ye() : [
...
function Q(e) {
	return Ze[e.split(".").at(-1)?.toLowerCase() ?? ""] ?? "plaintext";
}
//#endregion
...
function et(e) {
	...
	return {
		severity: e.severity === "error" ? s.Error : e.severity === "warning" ? s.Warning : s.Info,
		message: e.message,
		source: "DevMethod",
		startLineNumber: t,
		startColumn: n,
...
function tt(e) {
	let { t } = n(), r = t("Code source multicolore", "Syntax-highlighted source code"), i = (0, g.useRef)(r), a = (0, g.useRef)(null);
	(0, g.useLayoutEffect)(() => {
		i.current = r, a.current?.(r);
	}, [r]);
	let c = (0, g.useRef)(null), l = (0, g.useRef)(e);
	return (0, g.useLayoutEffect)(() => {
		l.current = e;
	}, [e]), (0, g.useLayoutEffect)(() => {
		if (!c.current) return;
		let e = ++$e, t = /* @__PURE__ */ new Map(), n = /* @__PURE__ */ new Map(), r = {
			...
			editContext: !1
		}, u = o.create(c.current, {
			...r,
			model: null
		}), d = null;
		a.current = (e) => {
			r.ariaLabel = e, u.updateOptions({ ariaLabel: e }), d?.getOriginalEditor().updateOptions({ ariaLabel: e });
		};
		let f = null, p = !1, m = !1, h = [], g = [];
		function _() {
			h.forEach((e) => e.dispose()), h = [u.onDidChangeModelContent(() => {
				!p && f && l.current.onChange?.(u.getValue());
			}), u.onDidChangeCursorPosition(({ position: e }) => {
				let t = u.getModel();
				t && l.current.onSelection?.({
					line: e.lineNumber,
					column: e.column,
					offset: t.getOffsetAt(e)
				});
			})], u.addCommand(te.CtrlCmd | ee.KeyS, () => l.current.onSave?.());
		}
		_();
		function v() {
			for (let [e, n] of t) o.setModelMarkers(n.model, $, g.filter((t) => !t.file || t.file === e).map(et));
		}
		function re() {
			let e = f && t.get(f.path);
			e && (e.state = u.saveViewState());
		}
		function y(e) {
			!!d !== e && (h.forEach((e) => e.dispose()), d ? d.dispose() : u.dispose(), e ? (d = o.createDiffEditor(c.current, {
				...r,
				readOnly: !0,
				originalEditable: !1,
				renderSideBySide: !1
			}), u = d.getModifiedEditor()) : (d = null, u = o.create(c.current, {
				...r,
				model: null
			})), _());
		}
		function b() {
			let e = u.getModel();
			e && l.current.onDiagnostics?.(Qe(o.getModelMarkers({ resource: e.uri })).map((e) => ({
				...f ? { file: f.path } : {},
				line: e.startLineNumber,
				column: e.startColumn,
				severity: e.severity === s.Error ? "error" : e.severity === s.Warning ? "warning" : "info",
				message: e.message
			})));
		}
		let x = o.onDidChangeMarkers((e) => {
			let t = u.getModel();
			...
			setDocument(r) {
				if (m) return;
				let i = f?.path !== r.path;
				(i || !!d != (r.original !== void 0)) && re(), y(r.original !== void 0);
				let a = t.get(r.path);
				if (!a) {
					let n = ne.parse(`file:///studio-${e}/${r.path.split("/").map(encodeURIComponent).join("/")}`);
					a = {
						model: o.createModel(r.value, Q(r.path), n),
						state: null
					}, t.set(r.path, a);
				}
				if (f = r, p = !0, a.model.getValue() !== r.value && a.model.setValue(r.value), d && r.original !== void 0) {
					let e = n.get(r.path);
					e ? e.getValue() !== r.original && e.setValue(r.original) : (e = o.createModel(r.original, Q(r.path)), n.set(r.path, e)), d.setModel({
						original: e,
						modified: a.model
					});
				} else u.getModel() !== a.model && u.setModel(a.model);
				u.updateOptions({ readOnly: r.readOnly }), i && a.state && u.restoreViewState(a.state), p = !1, c.current.dataset.language = Q(r.path);
				let s = u.getPosition();
				s && l.current.onSelection?.({
					line: s.lineNumber,
					column: s.column,
					offset: a.model.getOffsetAt(s)
				}), v(), b();
			},
			setDiagnostics(e) {
				g = e, v();
			...
			dispose() {
				if (!m) {
					m = !0, a.current = null, x.dispose(), h.forEach((e) => e.dispose()), d ? d.dispose() : u.dispose();
					for (let e of t.values()) o.setModelMarkers(e.model, $, []), e.model.dispose();
					n.forEach((e) => e.dispose());
				}
			}
		};
		return l.current.onReady(S), () => S.dispose();
	}, []), c;
}
//#endregion
...
function it(e, t = {}) {
	return i(e.ownerDocument, e.ownerDocument.defaultView ?? void 0), new Promise((n, r) => {
		let i = !1, a = (0, _.createRoot)(e, { onUncaughtError(e) {
			r(e), queueMicrotask(() => a.unmount());
		} });
		a.render(/* @__PURE__ */ (0, nt.jsx)(rt, {
			...t,
			onReady: (e) => n({
				...e,
				dispose() {
