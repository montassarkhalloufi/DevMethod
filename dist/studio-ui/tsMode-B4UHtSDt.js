import { a as e, c as t, i as n, l as r, o as i, s as a } from "./editor.api-CBhnZFl3.js";
import { a as o } from "./register-CoIKknfv.js";
import { t as s } from "./workers-Ct0B1W_j.js";
//#region node_modules/monaco-editor/esm/vs/languages/features/typescript/workerManager.js
var c = class {
	constructor(e, t) {
	...
	_getClient() {
		return this._client ||= (async () => (this._worker = s({
			...
			createWorker: () => new Worker(new URL(
				/* @vite-ignore */
				"/studio-ui/assets/ts.worker-ApoTl-3m.js",
				"" + import.meta.url
			), { type: "module" }),
			label: this._modeId,
			keepIdleModels: !0,
...
//#endregion
//#region node_modules/monaco-editor/esm/vs/languages/features/typescript/languageFeatures.js
function u(e, t, n = 0) {
...
var f = class {
	...
	static convertKind(e) {
		switch (e) {
			...
			case C.keyword: return r.CompletionItemKind.Keyword;
			case C.variable:
			case C.localVariable: return r.CompletionItemKind.Variable;
			case C.memberVariable:
			case C.memberGetAccessor:
			case C.memberSetAccessor: return r.CompletionItemKind.Field;
			case C.function:
			case C.memberFunction:
			case C.constructSignature:
			case C.callSignature:
			case C.indexSignature: return r.CompletionItemKind.Function;
			case C.enum: return r.CompletionItemKind.Enum;
			case C.module: return r.CompletionItemKind.Module;
			case C.class: return r.CompletionItemKind.Class;
			case C.interface: return r.CompletionItemKind.Interface;
			case C.warning: return r.CompletionItemKind.File;
		}
...
var _ = class e extends f {
	...
	async provideDocumentSymbols(e, t) {
		...
		let o = (t, n) => ({
			name: t.text,
			detail: "",
			kind: w[t.kind] || r.SymbolKind.Variable,
...
function L(e, t) {
	let n = [], i = new c(t, e), a = (...e) => i.getLanguageServiceWorker(...e), o = new p(a);
	function s() {
		let { modeConfiguration: i } = e;
		R(n), i.completionItems && n.push(r.registerCompletionItemProvider(t, new h(a))), i.signatureHelp && n.push(r.registerSignatureHelpProvider(t, new _(a))), i.hovers && n.push(r.registerHoverProvider(t, new v(a))), i.documentHighlights && n.push(r.registerDocumentHighlightProvider(t, new y(a))), i.definitions && n.push(r.registerDefinitionProvider(t, new b(o, a))), i.references && n.push(r.registerReferenceProvider(t, new x(o, a))), i.documentSymbols && n.push(r.registerDocumentSymbolProvider(t, new S(a))), i.rename && n.push(r.registerRenameProvider(t, new k(o, a))), i.documentRangeFormattingEdits && n.push(r.registerDocumentRangeFormattingEditProvider(t, new E(a))), i.onTypeFormattingEdits && n.push(r.registerOnTypeFormattingEditProvider(t, new D(a))), i.codeActions && n.push(r.registerCodeActionProvider(t, new O(a))), i.inlayHints && n.push(r.registerInlayHintsProvider(t, new A(a))), i.diagnostics && n.push(new m(o, e, t, a));
	}
	return s(), a;
}
function R(e) {
