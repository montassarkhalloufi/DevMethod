...
Installing the kit does not import an application into Studio or prove that its runtime, external services or tests work. Agent tools and application services have distinct requirements; use existing capabilities and accepted choices before proposing new ones.
