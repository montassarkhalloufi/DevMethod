...
const bundle = await build({
  entryPoints: ['studio-ui/src/features/project/components/architecture-model.ts'],
  bundle: true,
  write: false,
  format: 'esm',
  platform: 'node',
});
const { CARD, createGraphLayout, filterGraph, graphBounds, graphChanges, redactTrace } =
  await import(
