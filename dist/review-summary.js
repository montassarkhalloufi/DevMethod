import { summarizeReview, reviewFreshness, conclusionLabels, severityLabels, } from './review-model.js';
import { el } from './review-dom.js';
export function renderSummary(r, main, currentRevision, changedTargets) {
