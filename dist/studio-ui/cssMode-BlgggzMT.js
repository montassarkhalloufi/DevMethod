import { l as e } from "./editor.api-CBhnZFl3.js";
import { t } from "./workers-Ct0B1W_j.js";
import { _ as n, a as r, c as i, d as a, f as o, g as s, h as c, i as l, l as u, m as d, n as f, o as p, p as m, r as h, s as g, t as _, u as v, v as y } from "./lspLanguageFeatures-B9iGfGRp.js";
//#region node_modules/monaco-editor/esm/vs/languages/features/css/workerManager.js
var b = 12e4, x = class {
	constructor(e) {
	...
	_getClient() {
		return this._lastUsedTime = Date.now(), this._client ||= (this._worker = t({
			...
			createWorker: () => new Worker(new URL(
				/* @vite-ignore */
				"/studio-ui/assets/css.worker-fQD24i06.js",
				"" + import.meta.url
			), { type: "module" }),
...
//#endregion
//#region node_modules/monaco-editor/esm/vs/languages/features/css/cssMode.js
function S(t) {
	let n = [], s = [], c = new x(t);
	n.push(c);
