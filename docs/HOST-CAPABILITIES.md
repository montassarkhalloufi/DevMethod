...
| Fixture dispatch and local process supervision | Historical opt-in macOS pilot only | No DevMethod native adapter validated | No DevMethod native adapter validated |
