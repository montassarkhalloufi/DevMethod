import { a as e, c as t, i as n, l as r, n as i, r as a, s as o, t as s } from "./editor.api-CBhnZFl3.js";
import { t as c } from "./toggleHighContrast-wJCBnj4M.js";
import { a as l, i as u, n as d, r as f, t as p } from "./register-CoIKknfv.js";
//#region \0rolldown/runtime.js
var m = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), h = /* @__PURE__ */ m(((e) => {
	function t(e, t) {
		var n = e.length;
		e.push(t);
		a: for (; 0 < n;) {
	...
	e.unstable_IdlePriority = 5, e.unstable_ImmediatePriority = 1, e.unstable_LowPriority = 4, e.unstable_NormalPriority = 3, e.unstable_Profiling = null, e.unstable_UserBlockingPriority = 2, e.unstable_cancelCallback = function(e) {
		...
		return s = a + s, r = {
			...
			expirationTime: s,
			sortIndex: -1
		}, a > o ? (r.sortIndex = a, t(l, r), n(c) === null && r === n(l) && (h ? (v(ne), ne = -1) : h = !0, ce(ee, a - o))) : (r.sortIndex = s, t(c, r), m || p || (m = !0, te || (te = !0, ae()))), r;
		...
		if (e === null) c = !0;
			...
			case "object": switch (e.$$typeof) {
				...
				case n:
					c = !0;
					break;
				case d: return c = e._init, de(c(e._payload), r, i, a, o);
			}
		}
		if (c) return o = o(e), c = a === "" ? "." + le(e, 0) : a, ne(o) ? (i = "", c != null && (i = c.replace(ce, "$&/") + "/"), de(o, r, i, "", function(e) {
			return e;
		})) : o != null && (oe(o) && (o = ae(o, i + (o.key == null || e && e.key === o.key ? "" : ("" + o.key).replace(ce, "$&/") + "/") + c)), r.push(o)), 1;
		c = 0;
		var l = a === "" ? "." : a + ":";
		if (ne(e)) for (var u = 0; u < e.length; u++) a = e[u], s = l + le(a, u), c += de(a, r, i, s, o);
		else if (u = h(e), typeof u == "function") for (e = u.call(e), u = 0; !(a = e.next()).done;) a = a.value, s = l + le(a, u++), c += de(a, r, i, s, o);
		else if (s === "object") {
	...
	var Ee = Array.isArray, w = n.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, T = r.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, De = {
		pending: !1,
		data: null,
		method: null,
		action: null
	...
	var Ae = D(null), je = D(null), Me = D(null), k = D(null);
	function Ne(e, t) {
	...
	function A(e) {
		var t = e.memoizedState;
		t !== null && (sh._currentValue = t.memoizedState, O(k, e)), t = Ae.current;
		var n = dp(t, e.type);
		t !== n && (O(je, e), O(Ae, n));
	}
	function Fe(e) {
		je.current === e && (ke(Ae), ke(je)), k.current === e && (ke(k), sh._currentValue = De);
	}
	var Ie, Le;
	function Re(e) {
		if (Ie === void 0) try {
	...
	var Ue = Object.prototype.hasOwnProperty, j = t.unstable_scheduleCallback, We = t.unstable_cancelCallback, Ge = t.unstable_shouldYield, Ke = t.unstable_requestPaint, qe = t.unstable_now, Je = t.unstable_getCurrentPriorityLevel, M = t.unstable_ImmediatePriority, Ye = t.unstable_UserBlockingPriority, Xe = t.unstable_NormalPriority, Ze = t.unstable_LowPriority, Qe = t.unstable_IdlePriority, $e = t.log, et = t.unstable_setDisableYieldValue, tt = null, nt = null;
	function rt(e) {
	...
	}), Qn = Un(Zn), $n = Un(S({}, Zn, { dataTransfer: 0 })), er = Un(S({}, Kn, { relatedTarget: 0 })), tr = Un(S({}, Wn, {
		animationName: 0,
		elapsedTime: 0,
		pseudoElement: 0
	})), nr = Un(S({}, Wn, { clipboardData: function(e) {
		return "clipboardData" in e ? e.clipboardData : window.clipboardData;
	} })), rr = Un(S({}, Wn, { data: 0 })), ir = {
		Esc: "Escape",
		Spacebar: " ",
		Left: "ArrowLeft",
		Up: "ArrowUp",
	...
	var lr = Un(S({}, Kn, {
		...
		pointerType: 0,
		isPrimary: 0
	})), dr = Un(S({}, Wn, { submitter: 0 })), fr = Un(S({}, Kn, {
		touches: 0,
		targetTouches: 0,
		changedTouches: 0,
		altKey: 0,
	...
	function Hi(e, t, n, r, a, o) {
		...
		if (r = e, typeof r == "function") zi(r) && (s = 1);
			...
			case _e: return e = Ri(31, n, t, a), e.elementType = _e, e.lanes = o, e;
			case ce: return Ui(n.children, a, o, t);
			case le:
				s = 8, a |= 24;
				break;
			case ue: return e = Ri(12, n, t, a | 2), e.elementType = ue, e.lanes = o, e;
			case pe: return e = Ri(13, n, t, a), e.elementType = pe, e.lanes = o, e;
			case me: return e = Ri(19, n, t, a), e.elementType = me, e.lanes = o, e;
			case ve:
			case be: return e = a | 32, e = Ri(30, n, t, e), e.elementType = be, e.lanes = o, e.stateNode = {
				autoName: null,
				paired: null,
				clones: null,
				ref: null
	...
	var ba = D(null), xa = null, Sa = null;
	function Ca(e, t, n) {
		O(ba, t._currentValue), t._currentValue = n;
	}
	function wa(e) {
		e._currentValue = ba.current, ke(ba);
	}
	function Ta(e, t, n) {
		for (; e !== null;) {
			var r = e.alternate;
	...
	var Ja = w.S;
	w.S = function(e, t) {
		if (gd = qe(), typeof t == "object" && t && typeof t.then == "function" && Ga(e, t), za !== null) for (var n = bf; n !== null;) Ra(n, za), n = n.next;
		if (n = e.types, n !== null) {
	...
	function ho(e) {
		...
		function l(e, t, n, r) {
			var i = n.type;
			return i === ce ? (e = d(e, t, n.props.children, r, n.key), po(e, n), e) : t !== null && (t.elementType === i || typeof i == "object" && i && i.$$typeof === ge && ao(i) === t.type) ? (t = a(t, n.props), po(t, n), t.return = e, t) : (t = Hi(n.type, n.key, n.props, null, e.mode, r), po(t, n), t.return = e, t);
		}
		function u(e, t, n, r) {
		...
		function f(e, t, n) {
			...
			if (typeof t == "object" && t) {
				switch (t.$$typeof) {
					case oe: return n = Hi(t.type, t.key, t.props, null, e.mode, n), po(n, t), n.return = e, n;
					case se: return t = Ki(t, e.mode, n), t.return = e, t;
					case ge: return t = ao(t), f(e, t, n);
				}
				if (Ee(t) || Ce(t)) return t = Ui(t, e.mode, n, null), t.return = e, t;
				if (typeof t.then == "function") return f(e, fo(t), n);
				if (t.$$typeof === C) return f(e, ja(e, t), n);
				mo(e, t);
			}
			return null;
		}
		...
		function _(e, r, o, c) {
			if (typeof o == "object" && o && o.type === ce && o.key === null && o.props.ref === void 0 && (o = o.props.children), typeof o == "object" && o) {
				switch (o.$$typeof) {
					case oe:
						a: {
							for (var l = o.key; r !== null;) {
								if (r.key === l) {
									...
									} else if (r.elementType === l || typeof l == "object" && l && l.$$typeof === ge && ao(l) === r.type) {
							...
							o.type === ce ? (c = Ui(o.props.children, e.mode, c, o.key), po(c, o), c.return = e, e = c) : (c = Hi(o.type, o.key, o.props, null, e.mode, c), po(c, o), c.return = e, e = c);
						}
						return s(e);
					case se:
						a: {
						...
						return s(e);
					case ge: return o = ao(o), _(e, r, o, c);
				}
				...
				if (o.$$typeof === C) return _(e, r, ja(e, o), c);
				mo(e, o);
			}
	...
	function ns(e, t, n, r, i, a) {
		return Ko = a, L = t, t.memoizedState = null, t.updateQueue = null, t.lanes = 0, w.H = e === null || e.memoizedState === null ? vc : yc, Xo = !1, a = n(r, i), Xo = !1, Yo && (a = is(t, n, r, i)), rs(e), a;
	}
	function rs(e) {
		w.H = _c;
	...
	function ds(e) {
		var t = Qo;
		return Qo += 1, $o === null && ($o = []), e = io($o, e, t), t = L, (qo === null ? t.memoizedState : qo.next) === null && (t = t.alternate, w.H = t === null || t.memoizedState === null ? vc : yc), e;
	}
	function fs(e) {
		if (typeof e == "object" && e) {
	...
	function ps(e) {
		...
		if (t ??= {
			data: [],
			index: 0
		}, n === null && (n = us(), L.updateQueue = n), n.memoCache = t, n = t.data[t.index], n === void 0) for (n = t.data[t.index] = Array(e), r = 0; r < e; r++) n[r] = ye;
		return t.index++, n;
	}
	function ms(e, t) {
	...
	function gs(e, t, n) {
		...
		if (o = e.baseState, a === null) e.memoizedState = o;
			...
			if (l === null ? s = o : l.next = c, !qr(o, e.memoizedState) && (Ic = !0, d && (n = Wa, n !== null))) throw n;
	...
	function Es(e, t, n, r, a) {
		...
		if (e = t.action, e !== null) {
			...
			w.T === null ? o.isTransition = !1 : n(!0), r(o), n = t.pending, n === null ? (o.next = t.pending = o, Ds(t, o)) : (o.next = n.next, t.pending = n.next = o);
		}
	}
	function Ds(e, t) {
	...
	function tc(e, t, n, r, i) {
		...
		T.p = a !== 0 && 8 > a ? a : 8;
		var o = w.T, s = {};
		s.types = o === null ? null : o.types, w.T = s, pc(e, !1, t, n);
		try {
			var c = i(), l = w.S;
	...
	function rc(e, t, n, r) {
		...
		var a = ic(e).queue;
		tc(e, a, t, De, n === null ? nc : function() {
			return ac(e), n(r);
		});
	}
	function ic(e) {
	...
	function Pc(e, t, n, r, a) {
		if (n.flags |= 32768, typeof r == "object" && r && typeof r.then == "function") {
			if (t = n.alternate, t !== null && Da(t, n, a, !0), n = Fo.current, n !== null) {
				switch (n.tag) {
					case 31:
					case 13:
		...
		if (F) return t = Fo.current, t === null ? (r !== fa && (t = Error(i(423), { cause: r }), ya(Ji(t, n))), e = e.current.alternate, e.flags |= 65536, a &= -a, e.lanes |= a, r = Ji(r, n), a = jc(e.stateNode, r, a), wo(e, a), Y !== 4 && (Y = 2)) : (!(t.flags & 65536) && (t.flags |= 256), t.flags |= 65536, t.lanes = a, r !== fa && (e = Error(i(422), { cause: r }), ya(Ji(e, n)))), !1;
	...
	function Kc(e, t, n) {
		...
		if (o !== null) {
			...
			if (Ro(t), a) {
				...
				if (Ao.current === null) {
					if (r = G, r !== null && (s = St(r, n), s !== 0 && s !== o.retryLane)) throw o.retryLane = s, Ni(e, s), Pd(r, e, s), Fc;
					Kd();
				}
				t = Gc(e, t, n);
	...
	function al(e, t, n, r, a, o, s, c) {
		if (n) return t.flags & 256 ? (Lo(t), t.flags &= -257, il(e, t, c)) : t.memoizedState === null ? (Bo(), o = a.fallback, s = t.mode, a = rl({
			mode: "visible",
			children: a.children
		}, s), o = Ui(o, s, c, null), o.flags |= 2, a.return = t, o.return = t, a.sibling = o, t.child = a, go(t, e.child, null, c), a = t.child, a.memoizedState = $c(c), a.childLanes = el(e, r, c), t.memoizedState = Qc, Hc(null, a)) : (Bo(), t.child = e.child, t.flags |= 128, null);
		if (Lo(t), sm(o)) {
		...
		if (Ic || Da(e, t, c, !1), r = (c & e.childLanes) !== 0, Ic || r) {
			...
			if (r = G, r !== null && (a = St(r, c), a !== 0 && a !== s.retryLane)) throw s.retryLane = a, Ni(e, a), Pd(r, e, a), Fc;
	...
	function ml(e, t, n) {
		switch (t.tag) {
			case 3:
				Ne(t, t.stateNode.containerInfo), Ca(t, I, e.memoizedState.cache), _a();
				break;
			case 27:
			case 5:
				A(t);
		...
		switch (t.lanes = 0, t.tag) {
			...
			case 3:
				a: {
					...
					if (r = s.cache, Ca(t, I, r), r !== o.cache && Ea(t, [I], n, !0), Eo(), r = s.element, o.isDehydrated) {
						if (o = {
							element: r,
							isDehydrated: !1,
							cache: s.cache
				...
				return t;
			case 26: return qc(e, t), e === null ? (n = Nm(t.type, null, t.pendingProps, null)) ? t.memoizedState = n : F || (t.stateNode = fp(t.type, t.pendingProps, Me.current, t)) : t.memoizedState = Nm(t.type, e.memoizedProps, t.pendingProps, e.memoizedState), null;
			case 27: return A(t), e === null && F && (r = t.stateNode = hm(t.type, t.pendingProps, Me.current), la = t, da = !0, a = P, Sp(t.type) ? (um = a, P = lm(r.firstChild)) : P = a), Lc(e, t, t.pendingProps.children, n), qc(e, t), e === null && (t.flags |= 4194304), t.child;
			case 5: return e === null && F && ((a = r = P) && (r = rm(r, t.type, t.pendingProps, da), r === null ? a = !1 : (t.stateNode = r, la = t, P = lm(r.firstChild), da = !1, a = !0)), a || pa(t)), A(t), a = t.type, o = t.pendingProps, s = e === null ? null : e.memoizedProps, r = o.children, pp(a, o) ? r = null : s !== null && pp(a, s) && (t.flags |= 32), t.memoizedState !== null && (a = ns(e, t, as, null, null, n), sh._currentValue = a), qc(e, t), Lc(e, t, r, n), t.child;
			...
			case 4: return Ne(t, t.stateNode.containerInfo), r = t.pendingProps, e === null ? t.child = go(t, null, r, n) : Lc(e, t, r, n), t.child;
			...
			case 24: return ka(t), r = Aa(I), e === null ? (a = Xa(), a === null && (a = G, o = Ia(), a.pooledCache = o, o.refCount++, o !== null && (a.pooledCacheLanes |= n), a = o), t.memoizedState = {
				parent: r,
				cache: a
			}, yo(t), Ca(t, I, a)) : ((e.lanes & n) !== 0 && (bo(e, t), Do(t, null, null, n), Eo()), a = e.memoizedState, o = t.memoizedState, a.parent === r ? (r = o.cache, Ca(t, I, r), r !== a.cache && Ea(t, [I], n, !0)) : (a = {
				parent: r,
				cache: r
			}, t.memoizedState = a, t.lanes === 0 && (t.memoizedState = t.updateQueue.baseState = a), Ca(t, I, r))), Lc(e, t, t.pendingProps.children, n), t.child;
	...
	function xl(e, t, n) {
		...
		switch (sa(t), t.tag) {
			...
			case 3: return n = t.stateNode, r = null, e !== null && (r = e.memoizedState.cache), t.memoizedState.cache !== r && (t.flags |= 2048), wa(I), Pe(), n.pendingContext && (n.context = n.pendingContext, n.pendingContext = null), (e === null || e.child === null) && (ga(t) ? gl(t) : e === null || e.memoizedState.isDehydrated && !(t.flags & 256) || (t.flags |= 1024, va())), V(t), null;
			case 26:
			...
			case 27:
				if (Fe(t), n = Me.current, a = t.type, e !== null && t.stateNode != null) e.memoizedProps !== r && gl(t);
				else {
					if (!r) {
						if (t.stateNode === null) throw Error(i(166));
						return V(t), t.subtreeFlags &= -33554433, null;
					}
					e = Ae.current, ga(t) ? ma(t, e) : (e = hm(a, r, n), t.stateNode = e, gl(t));
				}
				return V(t), t.subtreeFlags &= -33554433, null;
			case 5:
			...
			case 19:
				...
				if (a = !!(t.flags & 128), o = r.rendering, o === null) {
					if (a) bl(r, !1);
						...
						r.tail !== null && qe() > _d && (t.flags |= 128, a = !0, bl(r, !1), t.lanes = 4194304);
					}
				} else {
					if (!a) {
						if (e = Go(o), e !== null) {
						...
						} else 2 * qe() - r.renderingStartTime > _d && n !== 536870912 && (t.flags |= 128, a = !0, bl(r, !1), t.lanes = 4194304);
					}
				...
				if (r.tail !== null) {
					...
					return r.rendering = e, r.tail = e.sibling, r.renderingStartTime = qe(), e.sibling = null, o = Ho.current, o = a ? o & 1 | 2 : o & 1, r.tailMode === "visible" || r.tailMode === "collapsed" || !n || F ? Uo(t, o) : (n = o, O(Fo, t), O(Ho, n), Io === null && (Io = t)), F && ia(t, r.treeForkCount), e;
				}
				return V(t), null;
			case 22:
	...
	function Sl(e, t) {
		switch (sa(t), t.tag) {
			...
			case 3: return wa(I), Pe(), e = t.flags, e & 65536 && !(e & 128) ? (t.flags = e & -65537 | 128, t) : null;
			case 26:
			case 27:
	...
	function Mu(e, t, n) {
		...
		switch (e.tag) {
			...
			case 6:
				...
				break;
			case 3:
				if (N = !1, Wm = null, o = ju, ju = bm(t.containerInfo), Au(t, e, n), ju = o, Nu(e), a & 4 && r !== null && r.memoizedState.isDehydrated) try {
					Hh(t.containerInfo);
				} catch (t) {
					Z(e, e.return, t);
				}
				...
				break;
			case 4:
				a = cu, cu = su, r = Qt(), o = ju, ju = bm(e.stateNode.containerInfo), Au(t, e, n), Nu(e), ju = o, N && pu && (mu = !0), N = r, cu = a;
				break;
			case 12:
				Au(t, e, n), Nu(e);
				break;
			case 31:
				...
				break;
			case 13:
				Au(t, e, n), Nu(e), e.child.flags & 8192 && e.memoizedState !== null != (r !== null && r.memoizedState !== null) && (hd = qe()), a & 4 && (t = e.updateQueue, t !== null && (e.updateQueue = null, ku(e, t)));
				break;
			case 22:
			...
			case 19:
				...
				break;
			case 30:
				a & 512 && (H || r === null || kl(r, r.return)), a = Qt(), o = pu, s = (n & 335544064) === n, c = e.memoizedProps, pu = s && Ti(c.default, c.update) !== "none", Au(t, e, n), Nu(e), s && r !== null && N && (e.flags |= 4), pu = o, N = a;
				break;
			case 21: break;
	...
	function jd() {
		return W & 2 && q !== 0 ? q & -q : w.T === null ? Tt() : Pf();
	}
	function Md() {
		if (ud === 0) {
			if (!(q & 536870912) || F) {
	...
	function Fd(e, t, n) {
		...
		do {
			...
			a: {
				...
				if ((t & 62914560) === t && (a = hd + 300 - qe(), 10 < a)) {
	...
	function Hd(e, t) {
		L = null, w.H = _c, t === $a || t === to ? (t = so(), J = 3) : t === eo ? (t = so(), J = 4) : J = t === Fc ? 8 : typeof t == "object" && t && typeof t.then == "function" ? 6 : 1, nd = t, K === null && (Y = 1, kc(e, Ji(t, e.current)));
	}
	function Ud() {
		var e = Fo.current;
	...
	function qd(e, t, n) {
		...
		while (1);
		return t && e.shellSuspendCounter++, Sa = xa = null, W = r, w.H = i, w.A = a, K === null && (G = null, q = 0, Ai()), o;
	}
	function Jd() {
		for (; K !== null;) Zd(K);
	}
	function Yd(e, t) {
		...
		W |= 2;
		var r = Wd(), a = Gd();
		G !== e || q !== t ? (vd = null, _d = qe() + 500, Vd(e, t)) : id = pt(e, t);
		a: do
			try {
				if (J !== 0 && K !== null) {
					t = K;
		...
		while (1);
		return Sa = xa = null, w.H = r, w.A = a, W = n, K === null ? (G = null, q = 0, Ai(), Y) : 0;
	}
	function Xd() {
		for (; K !== null && !Ge();) Zd(K);
	}
	...
	function ff() {
		...
		var e = bd, t = Cd;
		Cd = 0;
		var n = wt(Sd), r = w.T, a = T.p;
		try {
			T.p = 32 > n ? 32 : n, w.T = null, n = wd, wd = null;
			var o = bd, s = Sd;
			if (X = 0, xd = bd = null, Sd = 0, W & 6) throw Error(i(331));
			var c = W;
			if (W |= 4, Zu(o.current), Uu(o, o.current, s, n), W = c, Df(0, !1), nt && typeof nt.onPostCommitFiberRoot == "function") try {
	...
	function Af(e, t) {
		...
		if (t = G, n = q, n = ft(e, e === t ? n : 0, e.cancelPendingCommit !== null || e.timeoutHandle !== -1), r = e.callbackNode, n === 0 || e === t && (J === 2 || J === 9) || e.cancelPendingCommit !== null) return r !== null && r !== null && We(r), e.callbackNode = null, e.callbackPriority = 0;
		if (!(n & 3) || pt(e, n)) {
			if (t = n & -n, t === e.callbackPriority) return t;
			switch (r !== null && We(r), wt(n)) {
				case 2:
				case 8:
					n = Ye;
					break;
			...
			return r = jf.bind(null, e), n = j(n, r), e.callbackPriority = t, e.callbackNode = n, t;
		}
	...
	function jf(e, t) {
		...
		var r = q;
		return r = ft(e, e === G ? r : 0, e.cancelPendingCommit !== null || e.timeoutHandle !== -1), r === 0 ? null : (Fd(e, r, t), Af(e, qe()), e.callbackNode != null && e.callbackNode === n ? jf.bind(null, e) : null);
	}
	function Mf(e, t) {
		if (df()) return null;
		Fd(e, t, !0);
	...
	Fp.prototype.blur = function() {
		...
		e !== null && (e = y(e), e = lp(e).activeElement, e !== null && f(this._fragmentFiber.child, !1, Up, e, void 0, void 0));
	};
	function Up(e, t) {
		return e.tag !== 6 && (e = y(e), e === t || e.contains(t) ? (t.blur(), !0) : !1);
	}
	...
	Fp.prototype.getRootNode = function(e) {
		...
		if (n.length === 0) {
			...
			return n === e ? i = Node.DOCUMENT_POSITION_CONTAINS : r & Node.DOCUMENT_POSITION_CONTAINED_BY && (n = h(t)[1], n === null ? i = Node.DOCUMENT_POSITION_PRECEDING : (e = y(n).compareDocumentPosition(e), i = e === 0 || e & Node.DOCUMENT_POSITION_FOLLOWING ? Node.DOCUMENT_POSITION_FOLLOWING : Node.DOCUMENT_POSITION_PRECEDING)), i |= Node.DOCUMENT_POSITION_IMPLEMENTATION_SPECIFIC;
		}
		t = y(n[0]), i = y(n[n.length - 1]);
	...
	function Xp(e, t, n, r, i) {
		...
		return e & Node.DOCUMENT_POSITION_PRECEDING ? ((t = !!a) && !(t = a === n) && (t = ie(n, a, x), t === null ? t = !1 : (f(t, !0, ne, a, n), a = ee, ee = null, t = a !== null)), t) : e & Node.DOCUMENT_POSITION_FOLLOWING ? ((t = !!a) && !(t = a === r) && (t = ie(r, a, x), t === null ? t = !1 : (f(t, !0, re, a, r), a = ee, te = ee = null, t = a !== null)), t) : !1;
	}
	function Zp(e, t) {
		var n = e.ownerDocument.createRange();
	...
	Fp.prototype.scrollIntoView = function(e) {
		...
		for (r = n ? t.length - 1 : 0; r !== (n ? -1 : t.length);) {
			var a = t[r];
			a.tag === 6 ? (a = y(a), Zp(a, n)) : y(a).scrollIntoView(e), r += n ? -1 : 1;
		}
	};
	function Qp(e, t) {
		return e = y(e), $p(e, t), !1;
	}
	function $p(e, t) {
	...
	function Bm(e, t, n) {
		if (t.count++, t.instance === null) switch (t.type) {
			...
			case "script": return o = Rm(n.src), (a = e.querySelector(zm(o))) ? (t.instance = a, Ht(a), a) : (r = n, (a = vm.get(o)) && (r = S({}, n), Um(r, a)), e = e.ownerDocument || e, a = e.createElement("script"), Ht(a), np(a, "link", r), e.head.appendChild(a), t.instance = a);
	...
	n(), t.exports = ee();
})), ne = v(), re = te(), x = Object.defineProperty, ie = (e, t, n) => t in e ? x(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: n
}) : e[t] = n, S = (e, t, n) => ie(e, typeof t == "symbol" ? t : t + "", n), ae, oe, se, ce, le;
function ue(e) {
...
var fe = class {
	...
	constructor(e) {
		S(this, "_value"), S(this, "eventEmitter"), this._value = e, this.eventEmitter = new fe();
	}
	get value() {
		return this._value;
	}
...
ae = class {
	constructor() {
		S(this, "_unprocessedMessages", []), S(this, "_messageListener"), S(this, "id", ae.id++), S(this, "_state", new pe({ state: "open" })), S(this, "state", this._state);
	}
	setListener(e) {
...
var _e = class {
	...
	mapContext(t) {
		return new e((e) => this.connect(e ? be(e, t) : void 0));
	}
};
function be(e, t) {
	return {
...
var xe = class e {
	constructor(e, t, n) {
		S(this, "_stream"), S(this, "_listener"), S(this, "_logger"), S(this, "_unprocessedResponses", /* @__PURE__ */ new Map()), S(this, "_lastUsedRequestId", 0), this._stream = e, this._listener = t, this._logger = n, this._stream.setListener((e) => {
			ue(e) ? e.id === void 0 ? this._processNotification(e) : this._processRequest(e) : this._processResponse(e);
		});
	}
...
var Ce = Symbol("OptionalMethodNotFound"), we = class {
	contextualize(e) {
...
}, Ee = class e extends we {
	constructor(e, t = {}) {
		super(), S(this, "channelCtor"), S(this, "_requestSender"), S(this, "_handler", /* @__PURE__ */ new Map()), S(this, "_unknownNotificationHandler", /* @__PURE__ */ new Set()), S(this, "_timeout"), S(this, "sendExceptionDetails", !1), S(this, "_logger"), S(this, "listeningDeferred", new ge()), S(this, "onListening", this.listeningDeferred.promise), S(this, "_requestDidErrorEventEmitter", new fe()), S(this, "onRequestDidError", this._requestDidErrorEventEmitter.event), this.channelCtor = e, this._logger = t.logger, this.sendExceptionDetails = !!t.sendExceptionDetails, this._timeout = me(1e3, () => {
	...
	static fromTransport(t, n = {}) {
		return new e(xe.createChannel(t, n.logger), n);
	}
	startListen() {
	...
	async request(e, t, n) {
		...
		if ("error" in i) {
			if (e.isOptional && i.error.code === C.methodNotFound) return Ce;
			let t;
			...
			let n = new T(i.error.message, t, i.error.code);
...
${JSON.stringify(i, null, 2)}`);
	...
	async notify(e, t, n) {
		...
		let r = e.paramsSerializer.serializeToJson(t);
		w(r), this._requestSender.sendNotification({
			method: e.method,
			params: r
		}, n);
	}
...
var T = class e extends Error {
	constructor(t, n, r = C.genericApplicationError) {
...
function E(e) {
	return new De((e || {}).method, Se.sAny(), Se.sAny(), Se.sAny());
}
function D(e) {
	return new Oe((e || {}).method, Se.sAny());
}
var ke = (oe = Symbol(), se = class {
	constructor(e) {
		S(this, "error"), S(this, oe), this.error = e;
	}
}, S(se, "factory", (e) => new se(e)), se);
function O(e) {
	let t = Ae(e.server), n = Ae(e.client);
	return new je(e.tags || [], t, n);
}
function Ae(e) {
	let t = {};
...
var je = class e {
		...
		for (let [r, i] of Object.entries(t)) {
			...
			t = i.kind === "request" ? i.isOptional ? async (t, n) => {
				...
				try {
					...
					if (e && e.code === C.methodNotFound) return Ce;
					throw e;
				}
	...
	createRequestHandler(e, t) {
		return async (n, r, i) => {
			...
			return a instanceof ke ? a.error : { ok: a };
		};
	}
	static getServerFromStream(e, t, n, r) {
		let i = Ee.fromTransport(t, n), { server: a } = e.getServer(i, r);
	...
	static registerServerToStream(e, t, n, r) {
		let i = Ee.fromTransport(t, n), { client: a } = e.registerServer(i, r);
		return i.startListen(), {
			channel: i,
			client: a
		};
	...
	textDocumentImplementation: new j("textDocument/implementation"),
	textDocumentTypeDefinition: new j("textDocument/typeDefinition"),
	textDocumentDocumentColor: new j("textDocument/documentColor"),
	textDocumentColorPresentation: new j("textDocument/colorPresentation"),
	textDocumentFoldingRange: new j("textDocument/foldingRange"),
	textDocumentDeclaration: new j("textDocument/declaration"),
	textDocumentSelectionRange: new j("textDocument/selectionRange"),
	textDocumentPrepareCallHierarchy: new j("textDocument/prepareCallHierarchy"),
	textDocumentSemanticTokensFull: new j("textDocument/semanticTokens/full"),
	textDocumentSemanticTokensFullDelta: new j("textDocument/semanticTokens/full/delta"),
	textDocumentLinkedEditingRange: new j("textDocument/linkedEditingRange"),
	workspaceWillCreateFiles: new j("workspace/willCreateFiles"),
	workspaceWillRenameFiles: new j("workspace/willRenameFiles"),
	workspaceWillDeleteFiles: new j("workspace/willDeleteFiles"),
	textDocumentMoniker: new j("textDocument/moniker"),
	textDocumentPrepareTypeHierarchy: new j("textDocument/prepareTypeHierarchy"),
	textDocumentInlineValue: new j("textDocument/inlineValue"),
	textDocumentInlayHint: new j("textDocument/inlayHint"),
	textDocumentDiagnostic: new j("textDocument/diagnostic"),
	textDocumentInlineCompletion: new j("textDocument/inlineCompletion"),
	textDocumentWillSaveWaitUntil: new j("textDocument/willSaveWaitUntil"),
	textDocumentCompletion: new j("textDocument/completion"),
	textDocumentHover: new j("textDocument/hover"),
	textDocumentSignatureHelp: new j("textDocument/signatureHelp"),
	textDocumentDefinition: new j("textDocument/definition"),
	textDocumentReferences: new j("textDocument/references"),
	textDocumentDocumentHighlight: new j("textDocument/documentHighlight"),
	textDocumentDocumentSymbol: new j("textDocument/documentSymbol"),
	textDocumentCodeAction: new j("textDocument/codeAction"),
	workspaceSymbol: new j("workspace/symbol"),
	textDocumentCodeLens: new j("textDocument/codeLens"),
	textDocumentDocumentLink: new j("textDocument/documentLink"),
	textDocumentFormatting: new j("textDocument/formatting"),
	textDocumentRangeFormatting: new j("textDocument/rangeFormatting"),
	textDocumentRangesFormatting: new j("textDocument/rangesFormatting"),
	textDocumentOnTypeFormatting: new j("textDocument/onTypeFormatting"),
	textDocumentRename: new j("textDocument/rename"),
	workspaceExecuteCommand: new j("workspace/executeCommand"),
	workspaceDidCreateFiles: new j("workspace/didCreateFiles"),
	workspaceDidRenameFiles: new j("workspace/didRenameFiles"),
	workspaceDidDeleteFiles: new j("workspace/didDeleteFiles"),
	workspaceDidChangeConfiguration: new j("workspace/didChangeConfiguration"),
	textDocumentDidOpen: new j("textDocument/didOpen"),
	textDocumentDidChange: new j("textDocument/didChange"),
	textDocumentDidClose: new j("textDocument/didClose"),
	textDocumentDidSave: new j("textDocument/didSave"),
	textDocumentWillSave: new j("textDocument/willSave"),
	workspaceDidChangeWatchedFiles: new j("workspace/didChangeWatchedFiles")
};
O({
	server: {
		textDocumentImplementation: E({ method: "textDocument/implementation" }),
		textDocumentTypeDefinition: E({ method: "textDocument/typeDefinition" }),
		textDocumentDocumentColor: E({ method: "textDocument/documentColor" }),
		textDocumentColorPresentation: E({ method: "textDocument/colorPresentation" }),
		textDocumentFoldingRange: E({ method: "textDocument/foldingRange" }),
		textDocumentDeclaration: E({ method: "textDocument/declaration" }),
		textDocumentSelectionRange: E({ method: "textDocument/selectionRange" }),
		textDocumentPrepareCallHierarchy: E({ method: "textDocument/prepareCallHierarchy" }),
		callHierarchyIncomingCalls: E({ method: "callHierarchy/incomingCalls" }),
		callHierarchyOutgoingCalls: E({ method: "callHierarchy/outgoingCalls" }),
		textDocumentSemanticTokensFull: E({ method: "textDocument/semanticTokens/full" }),
		textDocumentSemanticTokensFullDelta: E({ method: "textDocument/semanticTokens/full/delta" }),
		textDocumentSemanticTokensRange: E({ method: "textDocument/semanticTokens/range" }),
		textDocumentLinkedEditingRange: E({ method: "textDocument/linkedEditingRange" }),
		workspaceWillCreateFiles: E({ method: "workspace/willCreateFiles" }),
		workspaceWillRenameFiles: E({ method: "workspace/willRenameFiles" }),
		workspaceWillDeleteFiles: E({ method: "workspace/willDeleteFiles" }),
		textDocumentMoniker: E({ method: "textDocument/moniker" }),
		textDocumentPrepareTypeHierarchy: E({ method: "textDocument/prepareTypeHierarchy" }),
		typeHierarchySupertypes: E({ method: "typeHierarchy/supertypes" }),
		typeHierarchySubtypes: E({ method: "typeHierarchy/subtypes" }),
		textDocumentInlineValue: E({ method: "textDocument/inlineValue" }),
		textDocumentInlayHint: E({ method: "textDocument/inlayHint" }),
		inlayHintResolve: E({ method: "inlayHint/resolve" }),
		textDocumentDiagnostic: E({ method: "textDocument/diagnostic" }),
		workspaceDiagnostic: E({ method: "workspace/diagnostic" }),
		textDocumentInlineCompletion: E({ method: "textDocument/inlineCompletion" }),
		initialize: E({ method: "initialize" }),
		shutdown: E({ method: "shutdown" }),
		textDocumentWillSaveWaitUntil: E({ method: "textDocument/willSaveWaitUntil" }),
		textDocumentCompletion: E({ method: "textDocument/completion" }),
		completionItemResolve: E({ method: "completionItem/resolve" }),
		textDocumentHover: E({ method: "textDocument/hover" }),
		textDocumentSignatureHelp: E({ method: "textDocument/signatureHelp" }),
		textDocumentDefinition: E({ method: "textDocument/definition" }),
		textDocumentReferences: E({ method: "textDocument/references" }),
		textDocumentDocumentHighlight: E({ method: "textDocument/documentHighlight" }),
		textDocumentDocumentSymbol: E({ method: "textDocument/documentSymbol" }),
		textDocumentCodeAction: E({ method: "textDocument/codeAction" }),
		codeActionResolve: E({ method: "codeAction/resolve" }),
		workspaceSymbol: E({ method: "workspace/symbol" }),
		workspaceSymbolResolve: E({ method: "workspaceSymbol/resolve" }),
		textDocumentCodeLens: E({ method: "textDocument/codeLens" }),
		codeLensResolve: E({ method: "codeLens/resolve" }),
		textDocumentDocumentLink: E({ method: "textDocument/documentLink" }),
		documentLinkResolve: E({ method: "documentLink/resolve" }),
		textDocumentFormatting: E({ method: "textDocument/formatting" }),
		textDocumentRangeFormatting: E({ method: "textDocument/rangeFormatting" }),
		textDocumentRangesFormatting: E({ method: "textDocument/rangesFormatting" }),
		textDocumentOnTypeFormatting: E({ method: "textDocument/onTypeFormatting" }),
		textDocumentRename: E({ method: "textDocument/rename" }),
		textDocumentPrepareRename: E({ method: "textDocument/prepareRename" }),
		workspaceExecuteCommand: E({ method: "workspace/executeCommand" }),
		workspaceDidChangeWorkspaceFolders: D({ method: "workspace/didChangeWorkspaceFolders" }),
		windowWorkDoneProgressCancel: D({ method: "window/workDoneProgress/cancel" }),
		workspaceDidCreateFiles: D({ method: "workspace/didCreateFiles" }),
		workspaceDidRenameFiles: D({ method: "workspace/didRenameFiles" }),
		workspaceDidDeleteFiles: D({ method: "workspace/didDeleteFiles" }),
		notebookDocumentDidOpen: D({ method: "notebookDocument/didOpen" }),
		notebookDocumentDidChange: D({ method: "notebookDocument/didChange" }),
		notebookDocumentDidSave: D({ method: "notebookDocument/didSave" }),
		notebookDocumentDidClose: D({ method: "notebookDocument/didClose" }),
		initialized: D({ method: "initialized" }),
		exit: D({ method: "exit" }),
		workspaceDidChangeConfiguration: D({ method: "workspace/didChangeConfiguration" }),
		textDocumentDidOpen: D({ method: "textDocument/didOpen" }),
		textDocumentDidChange: D({ method: "textDocument/didChange" }),
		textDocumentDidClose: D({ method: "textDocument/didClose" }),
		textDocumentDidSave: D({ method: "textDocument/didSave" }),
		textDocumentWillSave: D({ method: "textDocument/willSave" }),
		workspaceDidChangeWatchedFiles: D({ method: "workspace/didChangeWatchedFiles" }),
		setTrace: D({ method: "$/setTrace" }),
		cancelRequest: D({ method: "$/cancelRequest" }),
		progress: D({ method: "$/progress" })
	},
	client: {
		workspaceWorkspaceFolders: E({ method: "workspace/workspaceFolders" }).optional(),
		workspaceConfiguration: E({ method: "workspace/configuration" }).optional(),
		workspaceFoldingRangeRefresh: E({ method: "workspace/foldingRange/refresh" }).optional(),
		windowWorkDoneProgressCreate: E({ method: "window/workDoneProgress/create" }).optional(),
		workspaceSemanticTokensRefresh: E({ method: "workspace/semanticTokens/refresh" }).optional(),
		windowShowDocument: E({ method: "window/showDocument" }).optional(),
		workspaceInlineValueRefresh: E({ method: "workspace/inlineValue/refresh" }).optional(),
		workspaceInlayHintRefresh: E({ method: "workspace/inlayHint/refresh" }).optional(),
		workspaceDiagnosticRefresh: E({ method: "workspace/diagnostic/refresh" }).optional(),
		clientRegisterCapability: E({ method: "client/registerCapability" }).optional(),
		clientUnregisterCapability: E({ method: "client/unregisterCapability" }).optional(),
		windowShowMessageRequest: E({ method: "window/showMessageRequest" }).optional(),
		workspaceCodeLensRefresh: E({ method: "workspace/codeLens/refresh" }).optional(),
		workspaceApplyEdit: E({ method: "workspace/applyEdit" }).optional(),
		windowShowMessage: D({ method: "window/showMessage" }),
		windowLogMessage: D({ method: "window/logMessage" }),
		telemetryEvent: D({ method: "telemetry/event" }),
		textDocumentPublishDiagnostics: D({ method: "textDocument/publishDiagnostics" }),
		logTrace: D({ method: "$/logTrace" }),
		cancelRequest: D({ method: "$/cancelRequest" }),
		progress: D({ method: "$/progress" })
	}
}), ce = class {
	constructor() {
		S(this, "_store", new Ge());
	}
	dispose() {
		this._store.dispose();
	}
...
}, S(ce, "None", Object.freeze({ dispose() {} }));
var Ge = (le = class {
	constructor() {
	...
	add(e) {
		if (!e) return e;
		if (e === this) throw Error("Cannot register a disposable on itself!");
		return this._isDisposed ? le.DISABLE_DISPOSED_WARNING || console.warn((/* @__PURE__ */ Error("Trying to add a disposable to a DisposableStore that has already been disposed of. The added object will be leaked!")).stack) : this._toDispose.add(e), e;
	}
}, S(le, "DISABLE_DISPOSED_WARNING", !1), le);
Re.Empty, Re.QuickFix, Re.Refactor, Re.RefactorExtract, Re.RefactorInline, Re.RefactorRewrite, Re.Source, Re.SourceOrganizeImports, Re.SourceFixAll, r.CodeActionTriggerType.Invoke, Ue.Invoked, r.CodeActionTriggerType.Auto, Ue.Automatic, A.Text, r.CompletionItemKind.Text, A.Method, r.CompletionItemKind.Method, A.Function, r.CompletionItemKind.Function, A.Constructor, r.CompletionItemKind.Constructor, A.Field, r.CompletionItemKind.Field, A.Variable, r.CompletionItemKind.Variable, A.Class, r.CompletionItemKind.Class, A.Interface, r.CompletionItemKind.Interface, A.Module, r.CompletionItemKind.Module, A.Property, r.CompletionItemKind.Property, A.Unit, r.CompletionItemKind.Unit, A.Value, r.CompletionItemKind.Value, A.Enum, r.CompletionItemKind.Enum, A.Keyword, r.CompletionItemKind.Keyword, A.Snippet, r.CompletionItemKind.Snippet, A.Color, r.CompletionItemKind.Color, A.File, r.CompletionItemKind.File, A.Reference, r.CompletionItemKind.Reference, A.Folder, r.CompletionItemKind.Folder, A.EnumMember, r.CompletionItemKind.EnumMember, A.Constant, r.CompletionItemKind.Constant, A.Struct, r.CompletionItemKind.Struct, A.Event, r.CompletionItemKind.Event, A.Operator, r.CompletionItemKind.Operator, A.TypeParameter, r.CompletionItemKind.TypeParameter, Fe.Deprecated, r.CompletionItemTag.Deprecated, r.CompletionTriggerKind.Invoke, Ve.Invoked, r.CompletionTriggerKind.TriggerCharacter, Ve.TriggerCharacter, r.CompletionTriggerKind.TriggerForIncompleteCompletions, Ve.TriggerForIncompleteCompletions, Ie.Snippet, r.CompletionItemInsertTextRule.InsertAsSnippet, k.File, r.SymbolKind.File, k.Module, r.SymbolKind.Module, k.Namespace, r.SymbolKind.Namespace, k.Package, r.SymbolKind.Package, k.Class, r.SymbolKind.Class, k.Method, r.SymbolKind.Method, k.Property, r.SymbolKind.Property, k.Field, r.SymbolKind.Field, k.Constructor, r.SymbolKind.Constructor, k.Enum, r.SymbolKind.Enum, k.Interface, r.SymbolKind.Interface, k.Function, r.SymbolKind.Function, k.Variable, r.SymbolKind.Variable, k.Constant, r.SymbolKind.Constant, k.String, r.SymbolKind.String, k.Number, r.SymbolKind.Number, k.Boolean, r.SymbolKind.Boolean, k.Array, r.SymbolKind.Array, k.Object, r.SymbolKind.Object, k.Key, r.SymbolKind.Key, k.Null, r.SymbolKind.Null, k.EnumMember, r.SymbolKind.EnumMember, k.Struct, r.SymbolKind.Struct, k.Event, r.SymbolKind.Event, k.Operator, r.SymbolKind.Operator, k.TypeParameter, r.SymbolKind.TypeParameter, Ne.Deprecated, r.SymbolTag.Deprecated, Le.Text, r.DocumentHighlightKind.Text, Le.Read, r.DocumentHighlightKind.Read, Le.Write, r.DocumentHighlightKind.Write, Me.Comment, r.FoldingRangeKind.Comment, Me.Imports, r.FoldingRangeKind.Imports, Me.Region, r.FoldingRangeKind.Region, n.Error, ze.Error, n.Warning, ze.Warning, n.Info, ze.Information, n.Hint, ze.Hint, ze.Error, n.Error, ze.Warning, n.Warning, ze.Information, n.Info, ze.Hint, n.Hint, Be.Unnecessary, e.Unnecessary, Be.Deprecated, e.Deprecated, r.SignatureHelpTriggerKind.Invoke, He.Invoked, r.SignatureHelpTriggerKind.TriggerCharacter, He.TriggerCharacter, r.SignatureHelpTriggerKind.ContentChange, He.ContentChange, Pe.Type, r.InlayHintKind.Type, Pe.Parameter, r.InlayHintKind.Parameter, new Map([...Object.values(We)].map((e) => [e.method, e])), typeof WebSocket < "u" || (typeof MozWebSocket < "u" ? MozWebSocket : typeof global < "u" ? global.WebSocket || global.MozWebSocket : typeof window < "u" ? window.WebSocket || window.MozWebSocket : typeof self < "u" && (self.WebSocket || self.MozWebSocket));
//#endregion
//#region node_modules/monaco-editor/esm/vs/languages/definitions/_.contribution.js
var Ke = {}, qe = {}, Je = class e {
	static getOrCreate(t) {
		return qe[t] || (qe[t] = new e(t)), qe[t];
	}
	constructor(e) {
	...
	load() {
		return this._loadingTriggered || (this._loadingTriggered = !0, Ke[this._languageId].loader().then((e) => this._lazyLoadPromiseResolve(e), (e) => this._lazyLoadPromiseReject(e))), this._lazyLoadPromise;
	}
};
function M(e) {
	let t = e.id;
	Ke[t] = e, r.register(e);
	let n = Je.getOrCreate(t);
...
var Ye = class {
	constructor(e, t, n) {
		this._onDidChange = new s(), this._languageId = e, this.setOptions(t), this.setModeConfiguration(n);
	}
	get onDidChange() {
...
}, Qe = new Ye("css", Xe, Ze), $e = new Ye("scss", Xe, Ze), et = new Ye("less", Xe, Ze);
function tt() {
	return import("./cssMode-BlgggzMT.js");
}
r.onLanguage("less", () => {
	tt().then((e) => e.setupMode(et));
}), r.onLanguage("scss", () => {
	tt().then((e) => e.setupMode($e));
}), r.onLanguage("css", () => {
	tt().then((e) => e.setupMode(Qe));
});
//#endregion
...
function it(e) {
	return {
		...
		selectionRanges: !0,
		diagnostics: e === at,
		documentFormattingEdits: e === at,
		documentRangeFormattingEdits: e === at
	};
}
var at = "html", ot = "handlebars", st = "razor";
lt(at, rt, it(at)).defaults, lt(ot, rt, it(ot)).defaults, lt(st, rt, it(st)).defaults;
function ct() {
	return import("./htmlMode-BuU-k5Gz.js");
}
function lt(e, t = rt, n = it(e)) {
	let i = new nt(e, t, n), a, o = r.onLanguage(e, async () => {
		a = (await ct()).setupMode(i);
	});
	return {
		defaults: i,
		dispose() {
...
var ut = new class {
	constructor(e, t, n) {
		this._onDidChange = new s(), this._languageId = e, this.setDiagnosticsOptions(t), this.setModeConfiguration(n);
	}
	get onDidChange() {
		return this._onDidChange.event;
	}
...
r.register({
	...
	dt().then((e) => e.setupMode(ut));
});
//#endregion
//#region node_modules/monaco-editor/esm/vs/features/find/register.js
var ft = "__monacoFindWidgetTabIndexPatchApplied", pt = "__monacoFindWidgetOriginalTabIndex";
function mt(e, t) {
	let n = e?._domNode;
	if (!n) return;
	...
	for (let e of r) if (e instanceof HTMLElement) {
		if (t) {
			if (!(pt in e.dataset)) continue;
			let t = e.dataset[pt];
			t === "" ? e.removeAttribute("tabindex") : e.tabIndex = Number(t), delete e.dataset[pt];
		} else pt in e.dataset || (e.dataset[pt] = e.getAttribute("tabindex") ?? ""), e.tabIndex = -1;
	}
}
if (!c[ft]) {
	let e = c.prototype._reveal, t = c.prototype._hide;
	c.prototype._reveal = function(...t) {
		e.apply(this, t), mt(this, !0);
	}, c.prototype._hide = function(...e) {
		t.apply(this, e), mt(this, !1);
	}, c[ft] = !0;
}
//#endregion
...
globalThis.MonacoEnvironment = { getWorker(e, t) {
	return t === "typescript" || t === "javascript" ? new gt() : t === "json" ? new _t() : [
		"css",
		"scss",
		"less"
	].includes(t) ? new vt() : [
		...
		"handlebars",
		"razor"
	].includes(t) ? new yt() : new ht();
} }, l.setCompilerOptions({
	strict: !0,
	target: f.ESNext,
	module: d.ESNext,
	jsx: p.ReactJSX,
	allowNonTsExtensions: !0
}), l.setDiagnosticsOptions({
	noSemanticValidation: !0,
	noSyntaxValidation: !1
}), u.setDiagnosticsOptions({
	noSemanticValidation: !0,
	noSyntaxValidation: !1
}), t.defineTheme("devmethod-code", {
	base: "vs-dark",
	inherit: !0,
	rules: [],
	colors: {
...
function xt(e) {
	return bt[e.split(".").at(-1)?.toLowerCase() ?? ""] ?? "plaintext";
}
//#endregion
//#region studio-ui/src/features/code/model/diagnostics.ts
var St = "devmethod";
function Ct(e) {
	return e.filter((e) => e.owner !== St);
}
//#endregion
//#region studio-ui/src/features/code/hooks/useMonacoEditor.ts
var wt = 0;
function Tt(e) {
	let t = Math.max(1, e.line ?? 1), r = Math.max(1, e.column ?? 1);
	return {
		severity: e.severity === "error" ? n.Error : e.severity === "warning" ? n.Warning : n.Info,
		message: e.message,
		source: "DevMethod",
		startLineNumber: t,
		startColumn: r,
		endLineNumber: Math.max(t, e.endLine ?? t),
		endColumn: Math.max(r + 1, e.endColumn ?? r + 1)
	};
}
function Et(e) {
	let r = (0, ne.useRef)(null), s = (0, ne.useRef)(e);
	return (0, ne.useLayoutEffect)(() => {
		s.current = e;
	}, [e]), (0, ne.useLayoutEffect)(() => {
		if (!r.current) return;
		let e = ++wt, c = /* @__PURE__ */ new Map(), l = /* @__PURE__ */ new Map(), u = {
			...
			editContext: !1
		}, d = t.create(r.current, {
			...u,
			model: null
		}), f = null, p = null, m = !1, h = !1, g = [], _ = [];
		function v() {
			g.forEach((e) => e.dispose()), g = [d.onDidChangeModelContent(() => {
				!m && p && s.current.onChange?.(d.getValue());
			}), d.onDidChangeCursorPosition(({ position: e }) => {
				let t = d.getModel();
				t && s.current.onSelection?.({
					line: e.lineNumber,
					column: e.column,
					offset: t.getOffsetAt(e)
				});
			})], d.addCommand(a.CtrlCmd | i.KeyS, () => s.current.onSave?.());
		}
		v();
		function y() {
			for (let [e, n] of c) t.setModelMarkers(n.model, St, _.filter((t) => !t.file || t.file === e).map(Tt));
		}
		function b() {
			let e = p && c.get(p.path);
			e && (e.state = d.saveViewState());
		}
		function ee(e) {
			!!f !== e && (g.forEach((e) => e.dispose()), f ? f.dispose() : d.dispose(), e ? (f = t.createDiffEditor(r.current, {
				...u,
				readOnly: !0,
				originalEditable: !1,
				renderSideBySide: !1
			}), d = f.getModifiedEditor()) : (f = null, d = t.create(r.current, {
				...u,
				model: null
			})), v());
		}
		function te() {
			let e = d.getModel();
			e && s.current.onDiagnostics?.(Ct(t.getModelMarkers({ resource: e.uri })).map((e) => ({
				...p ? { file: p.path } : {},
				line: e.startLineNumber,
				column: e.startColumn,
				severity: e.severity === n.Error ? "error" : e.severity === n.Warning ? "warning" : "info",
				message: e.message
			})));
		}
		let ne = t.onDidChangeMarkers((e) => {
			let t = d.getModel();
			t && e.some((e) => e.toString() === t.uri.toString()) && te();
		}), re = {
			setDocument(n) {
				if (h) return;
				let i = p?.path !== n.path;
				(i || !!f != (n.original !== void 0)) && b(), ee(n.original !== void 0);
				let a = c.get(n.path);
				if (!a) {
					let r = o.parse(`file:///studio-${e}/${n.path.split("/").map(encodeURIComponent).join("/")}`);
					a = {
						model: t.createModel(n.value, xt(n.path), r),
						state: null
					}, c.set(n.path, a);
				}
				if (p = n, m = !0, a.model.getValue() !== n.value && a.model.setValue(n.value), f && n.original !== void 0) {
					let e = l.get(n.path);
					e ? e.getValue() !== n.original && e.setValue(n.original) : (e = t.createModel(n.original, xt(n.path)), l.set(n.path, e)), f.setModel({
						original: e,
						modified: a.model
					});
				} else d.getModel() !== a.model && d.setModel(a.model);
				d.updateOptions({ readOnly: n.readOnly }), i && a.state && d.restoreViewState(a.state), m = !1, r.current.dataset.language = xt(n.path);
				let u = d.getPosition();
				u && s.current.onSelection?.({
					line: u.lineNumber,
					column: u.column,
					offset: a.model.getOffsetAt(u)
				}), y(), te();
			},
			setDiagnostics(e) {
				_ = e, y();
			...
			focus(e) {
				e && (d.setPosition({
					lineNumber: e.line,
					column: e.column ?? 1
				}), d.revealLineInCenter(e.line)), d.focus();
			},
			dispose() {
				if (!h) {
					h = !0, ne.dispose(), g.forEach((e) => e.dispose()), f ? f.dispose() : d.dispose();
					for (let e of c.values()) t.setModelMarkers(e.model, St, []), e.model.dispose();
					l.forEach((e) => e.dispose());
				}
			}
		};
		return s.current.onReady(re), () => re.dispose();
	}, []), r;
}
//#endregion
...
function At(e, t = {}) {
	return new Promise((n, r) => {
		let i = !1, a = (0, re.createRoot)(e, { onUncaughtError(e) {
			r(e), queueMicrotask(() => a.unmount());
		} });
		a.render(/* @__PURE__ */ (0, Ot.jsx)(kt, {
			...t,
			onReady: (e) => n({
				...e,
				dispose() {
