...
| Interface Studio FR/EN | **IMPLEMENTED** | [i18n.js](../../../../scripts/studio/public/i18n.js) `initializeLocale`, `setLocale`, `subscribeLocale`; `studio-ui/src/i18n.ts` `useI18n` (source du checkout, non distribuée dans l’archive). [ADR 037](../../../ADR-037-studio-interface-language.md), recette dans [REPRISE](../REPRISE.md) : anglais par défaut, persistance et saisies conservées. Les contenus historiques gardent leur langue. |
| Harness d'évaluation optionnel | **EXPERIMENTAL** | `src/evidence-runtime.ts` `runEvidence`, distribué dans [evidence-runtime.js](../../../../dist/evidence-runtime.js), exposé comme expérimental dans `src/cli-commands.ts` et son [module distribué](../../../../dist/cli-commands.js). Il n'est ni un prérequis ajouté au Studio ni une preuve de sa boucle native. |
